...
# R "package" called "readr" that (among
# other things) reads data from URLs. 
...
SCOTUS <- read_csv("https://raw.githubusercontent.com/PrisonRodeo/GSERM-RFP-2022/master/Data/scotus.csv")
...
# row from the SCOTUS data, we could find him
# by looking in the data, note that he is in
# row number 27, and enter:
...
# it along with logical statements to
